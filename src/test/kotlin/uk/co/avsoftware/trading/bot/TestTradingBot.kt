...
class TestTradingBot {
    ...
    private val positionRepository: PositionRepository = mockk()
    ...
    fun testTradingBotShortTriggerWithOpenLongPosition(){
        ...
        every { stateRepository.updateState(State(exchange = "binance", symbol="SOLBTC", long_position=null, short_position="new-short-position-doc")) } returns Mono.just(finalShortState)
    ...
    fun testTradingBotShortTP(){
        ...
        every { tradeRepository.saveOrderResponse(buyOrderResponseA)} returns Mono.just("document-id")
        every { positionRepository.addCloseOrder( documentId = "short_pos_123", orderResponse = buyOrderResponseA) } returns Mono.just(position)
        every { stateRepository.updateState(State(exchange = "binance", symbol="SOLBTC", long_position=null, short_position=null)) } returns Mono.just(finalState)
